...
const CHECKLISTS = {
  'event-setup': {
    ...
    tasks: [
      ...
      'All remaining training equipment stored away (kettlebells, sandbags, wall balls, etc.)',
  ...
  'training-setup': {
    ...
    tasks: [
      ...
      'Wall ball targets hung',
      'Tall HYROX signs and stands brought up',
      'Every trash can has a fresh liner',
      'Trash can placed by the kitchen area',
      'Bathroom toilet paper and paper towels refilled',
      'Doorway to the stairs area is clean',
      'Windows cleaned',
